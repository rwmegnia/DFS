...
for season in range(2021,2022):
    ...
    schedule=schedule[schedule.week<22]
    season_snapcounts=pd.concat([frame for frame in schedule.apply(lambda x: get_game_snapcounts(x.gameday,x.home_team,x.away_team,x.week,x.season),axis=1)])
