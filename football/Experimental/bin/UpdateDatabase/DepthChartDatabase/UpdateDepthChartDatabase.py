...
seasontype='POST'  # or 'POST'
def updateDepthChartsDB(season,week,seasontype):
    if week>18:
        week-=18
    ...
    df.to_csv(f'{datadir}/DepthChartData/2001_present_game_depth_charts.csv',index=False)
