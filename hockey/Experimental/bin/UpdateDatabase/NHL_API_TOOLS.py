...
def getSeasonSchedule(season,gameType='R'):
    url = f"https://statsapi.web.nhl.com/api/v1/schedule?season={season}{season+1}&gameType={gameType}"
...
def getDKPts(df, player_type):
    ...
    if player_type == "skaters":
        ...
        df.loc[(df.goals_allowed == 0) & (df.timeOnIce >= 55), "shutout"] = 1
