...
for game_date in skater_db.game_date_string.unique():
    ...
    skater_games_df = skater_games_df[skater_games_df.Salary.isna() == False]
    goalie_games_df = goalie_db[goalie_db.game_date == game_date]
    goalie_games_df = goalie_games_df[goalie_games_df.Salary.isna() == False]
